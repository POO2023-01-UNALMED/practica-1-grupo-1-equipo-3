...
//		setup();
		...
		do {
			...
			System.out.println("7. Ver peticiones");
			System.out.println("--------- Otras opciones --------");
			System.out.println("8. Ver facturas");
			System.out.println("9. Ver tarjetas disponibles");
			...
			switch(opcion) {
				case 1: pagarFactura(banco); 
					break;
//				case 2: pagarFactura(banco) break;
//				case 3: pagarFactura(banco) break;
//				case 4: pagarFactura(banco) break;
//				case 5: pagarFactura(banco) break;
//				case 6: pagarFactura(banco) break;
//				case 7: pagarFactura(banco) break;
//				case 8: pagarFactura(banco) break;
//				case 9: pagarFactura(banco) break;
				case 0: System.out.println("Gracias por haber usado nuestro sistema");
					break;
		...
		static Cliente elejirUsuario(Banco banco) {
			...
			static void pagarFactura(Banco banco){				
				...
				System.out.println(clienteEscogido.nombre);
